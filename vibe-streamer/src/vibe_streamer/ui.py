from PySide6.QtWidgets import (
    ...
    QListWidget, QLabel, QPushButton, QInputDialog,
...
class SettingsDialog(QDialog):
    ...
    def add_dir(self):
        path, ok = QInputDialog.getText(self, "Add Directory", "Enter absolute path to directory:")
        if ok and path:
            ...
            if not p.exists():
                ...
                self.list_widget.addItem(path)
                QMessageBox.information(self, "Success", f"Successfully added {path} to root directories.")
